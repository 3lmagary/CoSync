...
2.  Install dependencies and build the plugin:
    ...
    npm run build
    ```
3.  Copy the compiled files (`main.js`, `manifest.json`, and `styles.css`) into your Obsidian vault's plugin directory: `<vault>/.obsidian/plugins/obsidian-cosync/`.
4.  Open Obsidian settings, enable **Community Plugins**, and turn on **Obsidian CoSync**.
